...
| File | Purpose |
|---|---|
| `disciplines.yml` | Which discipline-lead agents are active. Tells you which `systems-first-<discipline>@photonforge` plugins to install. |
...
All three are YAML. `sf-docs` and the agents read them
